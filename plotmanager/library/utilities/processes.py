    ...
    for datetime_start, process in chia_processes:
        ...
        for job in jobs:
            ...
            if destination_directory not in job.destination_directory:
                continue
            if temporary2_directory and (temporary2_directory not in job.temporary2_directory or (job.temporary2_destination_sync and temporary2_directory == destination_directory)):
                continue
